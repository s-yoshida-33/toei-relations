...
export default function Service() {
  return (
    <section className="relative w-full py-32 bg-white overflow-hidden">
      {/* 背景の巨大テキスト（右寄せ・画面幅に対して配置） */}
      <h2 className="absolute top-10 -right-8 text-[12rem] lg:text-[16rem] font-black text-[#0f3c75] tracking-tighter leading-none z-0 pointer-events-none select-none">
        SERVICE
      </h2>
